...
public class ListCategoriesUseCaseIT {
    ...
    public void mockUp() {
        final List<CategoryJpaEntity> categories = Stream.of(
                ...
                Category.newCategory("Netflix Originals", "T�tulos de autoria", true),
                Category.newCategory("Amazon Originals", "T�tulos de autoria da Amazon", true),
                Category.newCategory("Document�rios", null, true),
                Category.newCategory("Sports", null, true),
                Category.newCategory("Kids", "Categoria para Crian�as", true),
